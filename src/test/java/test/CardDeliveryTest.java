...
public class CardDeliveryTest {
    ...
    void shouldSuccessfulPlanMeeting() {
        ...
        int dayToAddForFirstMeeting = 3;
        String firstMeetingDate = DataGenerator.generateDate(dayToAddForFirstMeeting);
        int dayToAddForSecondMeeting = 7;
        String secondMeetingDate = DataGenerator.generateDate(dayToAddForSecondMeeting);
        ...
        $("[data-test-id='replan-notification'] .notification__content")
                .shouldHave(exactText("У вас уже запланирована встреча на другую дату. Перепланировать?"), Duration.ofSeconds(15))
    ...
    @Test
    @DisplayName("Should get error message if wrong phone number")
